...
if (missingSecrets.length > 0) {
  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    console.warn(`[DEV MODE] Using auto-generated secrets for: ${missingSecrets.join(', ')}. Set these in your .env file for consistent authentication.`);
  }
}

// Use provided secrets or generate secure fallbacks for development only
