...
console.log('[Sanity] Initializing client with:');
console.log('[Sanity] Project ID:', PROJECT_ID);
console.log('[Sanity] Dataset:', DATASET);
console.log('[Sanity] API Version: 2024-01-01');
console.log('[Sanity] Use CDN:', USE_CDN);
